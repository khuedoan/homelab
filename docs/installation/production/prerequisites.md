...
Because [this project](https://github.com/pando85/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork khuedoan/homelab](https://github.com/pando85/homelab/fork){ .md-button }
