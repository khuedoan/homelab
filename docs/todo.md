...
- [(bug) Should be posible to put it in the profile instead lxd_profile.kubenode.config, and make it a variable](../infra/cluster.tf#L101)
- [(bug) Use containers instead of virtual machines for Kubernetes nodes https](../infra/cluster.tf#L94)
