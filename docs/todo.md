...
- [(feature) Enable etcd authentication and generate terraform backend config variables](../metal/roles/tfstate/tasks/main.yml#L48)
...
- [(optimize) Use btrfs in k8s 1.19.8 https](../metal/roles/lxd/templates/leader.yaml.j2#L9)
...
- [(optimize) Use template for tfvars](../metal/roles/lxd/tasks/main.yml#L66)
